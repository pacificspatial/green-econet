...
export const ClippedItemsMap: React.FC<ClippedItemsMapProp> = ({ center, zoom, storedPolygons }) => {
  ...
  }, [projectId, basemap, addProjectPolygonsLayer, getClippedLayers, selectedProject, storedPolygons]);
